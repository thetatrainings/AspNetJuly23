...
namespace ThetaEcommerce.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(theta_ecommerceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            //var list= _context.Admins.ToList();
              ...
              return _context.Admins != null ? View(await _context.Admins.ToListAsync()) : Problem("Entity set 'theta_ecommerceContext.Admins'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var admin = await _context.Admins.Where(m => m.Id == id).FirstOrDefaultAsync();
            if (admin == null)
            {
                return NotFound();
            }
