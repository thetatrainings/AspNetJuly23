...
namespace ThetaEcommerce.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(theta_ecommerceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Description,CreatedBy,ModifiedBy,CreatedDate,ModifiedDate,Status")] Category category)
        {
